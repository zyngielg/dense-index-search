...
class REALM_like_retriever_BERT_for_multiple_choice_reader_trainer(Trainer):
    def __init__(self, questions: MedQAQuestions, retriever: REALM_like_retriever, reader: BERT_multiple_choice_reader, num_epochs: int, batch_size: int, lr: float) -> None:

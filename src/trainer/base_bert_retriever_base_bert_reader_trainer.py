...
class BaseBERTRetrieverBaseBERTReaderTrainer(Trainer):
    ...
    def train(self):
        ...
        training_stats_file = f"src/results/{dt_string}__Base0.json"
        ...
        retriever_file_name = f"src/trainer/bert-based/{dt_string}__BERT_retriever__Base_BERT_reader.pth"
        ...
        reader_file_name = f"src/trainer/results/{dt_string}__BERT_retriever__Base_BERT_reader.pth"
